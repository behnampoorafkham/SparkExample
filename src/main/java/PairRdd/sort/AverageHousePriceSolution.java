...
import PairRdd.aggregation.combinebykey.housePrice.AvgCount;
...
public class AverageHousePriceSolution {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SparkConf conf = new SparkConf().setAppName("fifteenth").setMaster("local[3]");
        JavaSparkContext sc = new JavaSparkContext(conf);

        JavaRDD<String> lines = sc.textFile("src/main/resources/RealEstate.csv");
